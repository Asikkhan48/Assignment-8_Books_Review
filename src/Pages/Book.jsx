...
import { saveBook } from '../Utils/Index';
...
const Book = () => {
	...
	<article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
		<div className="space-y-6">
			<h1 className="text-4xl font-bold md:tracking-tight md:text-5xl">{book.bookName}</h1>
	...
	<div>
		...
		<div className="space-y-2">
			...
			<ul className="ml-4 space-y-1 list-disc">
				...
				<div>
					<button onClick={ () => handleRead(book)} className='btn btn-primary p-2 font-medium mr-10'>Read</button>
					<button className='btn btn-secondary p-2 font-medium'>Wishlist</button>
				</div>
            </div>
          </div>
